                ...
                <div class="col-10">
                                    ...
                                    <div class="row d-flex justify-content-between align-items-center">
                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                            @if (empty($details['foto']))
                                                <img src="{{ url('admin/image/nophoto.jpg') }}" class="img-fluid rounded-3"
                                                    alt="No photo available">
                                            @else
                                                <img src="{{ url('admin/image') }}/{{ $details['foto'] }}"
                                                    class="img-fluid rounded-3" alt="{{ $details['nama'] }}">
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                            <h5 class="mb-0">
                                                Rp.{{ number_format($details['harga_jual'] * $details['quantity'], 0, ',', '.') }}
                                            </h5>
                                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-warning btn-block btn-lg" id="pay-button">Proceed to
                                Pay</button>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(".update-cart").change(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    _token: '{{ csrf_token() }}',
                    id: ele.parents("div.row").find(".remove-from-cart").attr("data-id"),
                    quantity: ele.parents("div.row").find(".quantity").val()
                },
