...
@section('konten')
    ...
    <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="text2" name="harga_beli" type="text"
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="text3" name="harga_jual" type="text"
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="text5" name="stok" type="text"
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="text4" name="min_stok" type="text"
